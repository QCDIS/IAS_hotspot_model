...
Speciespath <- "/mnt/inputs/Speciespath/species"
...
#Modelpath <- "/mnt/outputs/models/models apr 2020"
...
#mappath <- "/mnt/outputs/maps/maps apr 2020"
...
#rastermappath <- "/mnt/outputs/predict.rasters/predict rasters apr 2020"
...
ICESstatrectpath <- "/mnt/outputs/ICES_StatRec_mapto_ICES_Areas"
...
shape2 <- readOGR(dsn=NUTS_shapefile,layer="nutsByHand")
